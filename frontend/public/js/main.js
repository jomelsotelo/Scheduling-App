(function ($) {
    ...
    function new_event(event) {
        ...
        $("#cancel-button").click(function () {
            ...
            $("#startTime").removeClass("error-input");
            $("#endTime").removeClass("error-input");
        ...
        $("#ok-button").unbind().click({ date: event.data.date }, function () {
            ...
            if (name.length === 0) {
                ...
                new_event_json(name, startTime, endTime, count, date, day);
                date.setDate(day);
                init_calendar(date);
            }
        });
    ...
    function new_event_json(name, startTime, endTime, count, date, day) {
        var event = {
            "occasion": name,
            "start": startTime,
            "end": endTime,
    ...
    function show_events(events, month, day) {
        ...
        if (events.length === 0) {
            ...
            for (var i = 0; i < events.length; i++) {
                ...
                var event_time = $("<div class='event-count'> From " + events[i]["start"] + " to " + events[i]["end"] + "</div>");
